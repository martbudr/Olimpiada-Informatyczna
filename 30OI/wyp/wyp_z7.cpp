        ...
        if(zlacz[curr.second] <= curr.second && ost <= curr.second){ // jesli dany nie zostal jeszcze zlaczony z nastepnym
            ...
            while(true){
                ...
                if(miej_next.first * 1LL * miej_ost.second / ost_mom.second >=
                   miej_next.second / ost_mom.second * 1LL * (dlu[0] * 1LL * miej_ost.second + miej_ost.first)){ cout << miej_next.first * 1LL * miej_ost.second / ost_mom.second <<
                   ' ' << miej_next.second / ost_mom.second * 1LL * (dlu[0] * 1LL * miej_ost.second + miej_ost.first) << '\n'; wynik++;}
